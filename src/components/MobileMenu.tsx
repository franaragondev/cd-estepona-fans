    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          exit={{ opacity: 0 }}
        >
          <motion.aside className="fixed top-16 left-0 h-[calc(100%-4rem)] w-64 bg-white/30 dark:bg-gray-900/30 backdrop-blur-md border-r border-white/20 dark:border-gray-700/20 shadow-lg z-50 p-4">
